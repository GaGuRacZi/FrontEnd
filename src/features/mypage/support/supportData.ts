...
작성글은 소통·장터별로, 찜한 글은 소통·장터별로 확인할 수 있습니다. 같은 게시글에 여러 댓글을 남긴 경우 가장 최근 댓글과 나머지 댓글 수도 함께 표시됩니다.
...
운영정책을 확인하고 안전한 커뮤니티 이용 기준을 지켜주세요.`,
  ...
  {
    body: `반려동물 상세 화면에서 기본 정보와 성별 정보를 한곳에서 확인할 수 있습니다.

정보가 바뀌면 수정 화면에서 바로 반영할 수 있고, 등록한 사진도 함께 관리할 수 있습니다.`,
